...
const AboutHero = () => {
	return (
			<div className="py-16 md:pt-24 md:pb-20">
				<div className="flex flex-col items-start justify-start lg:flex-row moveUp">
					...
					<div className="flex flex-col items-start lg:pr-24">
						<h1 className="max-w-xl mb-8 text-2xl font-medium !leading-snug lg:max-w-3xl lg:text-5xl">
							<span className="font-bold">Product Designer, crazy about Design Systems</span> based in Brasilia, Brazil.
						</h1>
					</div>
				</div>
				<div className="flex flex-col items-start justify-start mt-4 lg:flex-row lg:mt-24">
					...
					<div className="max-w-md space-y-2 text-lg lg:pr-12 lg:max-w-2xl lg:text-xl">
				...
				<div className="flex flex-col items-start justify-start mt-4 lg:flex-row lg:mt-16">
					<span className="max-w-lg pt-12 pb-4 mr-0 text-xl font-medium lg:pb-0 lg:pt-4 lg:mr-40 lg:w-32">
						how did I get here?
					</span>
					<div className="max-w-md space-y-8 text-lg lg:pr-12 lg:max-w-2xl lg:text-xl">
						<p>
						...
						DM me on Linkedin</ExternalLink> or just <ExternalLink href="mailto:alo@bruna.design">
