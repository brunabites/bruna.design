  ...
  return (
    <div className="p-4 border rounded-sm bg-warning-50">
      <div className="flex items-center justify-start mb-4">
        ...
        <span className="w-64 ml-2 font-bold leading-tight tracking-wide text-warning-800 md:w-full">
  ...
  return (
    <div className="p-4 border rounded-sm bg-blue-50">
      <div className="flex items-center justify-start mb-4">
        ...
        <span className="w-64 ml-2 font-bold leading-tight tracking-wide text-blue-800 md:w-full">
          {props.title ? props.title : props.type}
        </span>
      </div>
  ...
  return (
    <div className="p-4 border rounded-sm bg-secondary-50">
      <div className="flex items-center justify-start mb-4">
        ...
        <span className="w-64 ml-2 font-bold leading-tight tracking-wide text-secondary-800 md:w-full">
          {props.title ? props.title : props.type}
        </span>
      </div>
  ...
  return (
    <div className="p-4 border rounded-sm bg-teal-50">
      <div className="flex items-center justify-start mb-4">
        ...
        <span className="w-64 ml-2 font-bold leading-tight tracking-wide text-teal-800 md:w-full">
          {props.title ? props.title : props.type}
        </span>
      </div>
  ...
  return (
    <div className="p-4 border rounded-sm bg-error-50">
      <div className="flex items-center justify-start mb-4">
        ...
        <span className="w-64 ml-2 font-bold leading-tight tracking-wide md:w-full text-error-800">
          {props.title ? props.title : props.type}
        </span>
      </div>
  ...
  return (
    <div className="p-4 border rounded-sm bg-rose-50">
      <div className="flex items-center justify-start mb-4">
        ...
        <span className="w-64 ml-2 font-bold leading-tight tracking-wide md:w-full text-rose-800">
          {props.title ? props.title : props.type}
        </span>
      </div>
  ...
  return (
    <div className="p-4 border rounded-sm bg-secondary-50">
      <div className="flex items-center justify-start mb-4">
        ...
        <span className="w-64 ml-2 font-bold leading-tight tracking-wide md:w-full text-secondary-800">
          {props.title ? props.title : props.type}
        </span>
      </div>
      <div className="text-base font-normal prose-p:mt-0 prose-p:mb-2 text-secondary-700">
